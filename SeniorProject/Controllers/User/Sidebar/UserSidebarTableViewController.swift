//
//  UserSidebarTableViewController.swift
//  SeniorProject
//
...
class UserSidebarTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if indexPath.row == 1 {
            let destination = storyboard?.instantiateViewController(withIdentifier: "userSelectTimeView") as! UserSelectTimeViewController
            destination.currentUser = currentUser
            navigationController?.pushViewController(destination, animated: true)
        } else if indexPath.row == 2 {
            let destination = storyboard?.instantiateViewController(withIdentifier: "userReservationsTableView") as! UserReservationsTableViewController
